      ...
      >
        <Box sx={{ width: 260 }}>
          ...
          <List>
            ...
            <ListItemButton onClick={() => handleNavigate('/admin/edificios')}>
              <ListItemText primary="Edificios" sx={drawerTextStyle} />
            </ListItemButton>

            <ListItemButton onClick={() => handleNavigate('/admin/espacios')}>
              <ListItemText primary="Espacios" sx={drawerTextStyle} />
            </ListItemButton>
