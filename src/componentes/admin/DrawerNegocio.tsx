...
export const DrawerNegocio = () => {
  ...
  return (
    ...
    >
      <List>
        <ListItemButton onClick={() => navigate('/indicadores/negocio/espacio')}>
          <ListItemText primary="Facturacion por espacio" />
        </ListItemButton>

        <Divider sx={{ backgroundColor: 'rgba(255,255,255,0.3)' }} />

        <ListItemButton onClick={() => navigate('/indicadores/negocio/edificio')}>
          <ListItemText primary="Facturacion por edificio" />
        </ListItemButton>
        
        <Divider sx={{ backgroundColor: 'rgba(255,255,255,0.3)' }} />

        <ListItemButton onClick={() => navigate('/indicadores/negocio/total')}>
